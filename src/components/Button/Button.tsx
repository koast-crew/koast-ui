...
import { getButtonStyles, getLoadingIndicator } from './Button.utils';
import { iconContainer } from './Button.styles.css';
...
export const Button = (props: ButtonProps) => {
  ...
  const buttonContent = (
    <>
      ...
      <span>{children}</span>
      {endIcon && <span className={iconContainer}>{endIcon}</span>}
      {loadingIndicator}
    </>
  );
